...
\PSfig[h]{Fig1_type1_error}{Type I error: We reject the null hypothesis when the computed statistic falls in the tails
and defer judgment if it falls in the central area.}
...
\PSfig[h]{Fig1_dice}{The critical values of correlation, i.e., how large the observed correlation would have
