...
gmt psxy -R-6/6/-0.4/0.9 -JX2.5i/0.9i -P -K ft.d -W0.5p -X1.25i -Y8.6i >! $FIG.ps
...
## 1b. D(f)
gmt psxy -R-1.5/1.5/0/1.1 -JX2.5i/0.8i -O -K wiggle.d -X3.5i -Y0.225i >> $FIG.ps
...
4 0.5
EOF
gmt psxy -R-1/5/0/1 -JX2.5i/0.5i -O -K -Sv0.1i+e -Gblack -N c.d --PROJ_LENGTH_UNIT=inch -Wthicker,black -X${dx2} -Y-0.9i >> $FIG.ps
...
gmt psxy -R-2/2/0/1 -JX2.5i/0.5i -O -K -Sv0.1i+e -Gblack -N t.d -X${dx1} --PROJ_LENGTH_UNIT=inch -Wthicker,black >> $FIG.ps
...
gmt psxy -R-6/6/-0.5/1 -JX2.5i/1i -O -K -Sv0.1i+e -Gblack -N f.d --PROJ_LENGTH_UNIT=inch -Wthicker,black -X${dx2} -Y-1.65i >> $FIG.ps
...
gmt psxy -R0/8/0/1.1 -JX2.5i/0.7i -O -K wiggle.d t?.d -W0.25p,- -X${dx1} -Y0.33i >> $FIG.ps
...
gmt psxy -R-6/6/0/1 -JX2.5i/1i -O -K -W1p -X${dx2} -Y-1.5i << EOF >> $FIG.ps
-6 0
-5 0
-5 0.5
5 0.5
...
gmt psxy -R-6/6/-0.5/1 -JX2.5i/1i -O -K ft.d -X${dx1} -Y-0.32i  >> $FIG.ps
gmt psxy -R -J -O -K -Sv0.1i+e -Gblack -N -Wthicker,black << EOF >> $FIG.ps
-6 0 0 2.5i
0 0 90 1i
2.5 0.4 220 0.3i
...
gmt psxy -R-6/6/-0.5/1 -JX2.5i/1i -O -K -Sv0.1i+e -Gblack -N f.d --PROJ_LENGTH_UNIT=inch -Wthicker,black -X${dx2} -Y-1.4i >> $FIG.ps
...
gmt psxy -R0/8/0/1.1 -JX2.5i/0.7i -O -K wiggle.d -W0.75p -X${dx1} -Y0.33i >> $FIG.ps
...
1 0.5
EOF
gmt psxy -R-2/2/0/1 -JX2.5i/0.5i -O -K -Sv0.1i+e -Gblack -N t.d --PROJ_LENGTH_UNIT=inch -Wthicker,black -X${dx2} -Y-0.95i >> $FIG.ps
...
gmt psxy -R-1/5/0/1 -JX2.5i/0.5i -O -K -Sv0.1i+e -Gblack -Wthicker,black -N c.d -X${dx1} --PROJ_LENGTH_UNIT=inch >> $FIG.ps
...
gmt psxy -R-13/13/-0.5/1.1 -JX2.5i/1i -O -K -Sv0.1i+e -Gblack r.d --PROJ_LENGTH_UNIT=inch -Wthicker,black -X${dx2} -Y-1.8i>> $FIG.ps
...
gmt psxy -R0/8/0/1.1 -JX2.5i/0.7i -O -K w.d -Sv0.1i+e -Gblack -N -X${dx1} -Y0.33i -Wthicker,black --PROJ_LENGTH_UNIT=inch >> $FIG.ps
echo "0 0 0 2.5i" | gmt psxy -R -J -O -K -Sv0.1i+e -Gblack -Wthicker,black -N >> $FIG.ps
gmt pstext -R -J -O -K -Dj0.05i/0.10i -N -F+f10p,Times-Italic+j << EOF >> $FIG.ps
8.1 0.04 TC f
4 1.61 CM =
