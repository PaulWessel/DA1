...
gmt psxy -R-4/4/0/5.3 -Jx1i -P -K -W0.25p << EOF > $FIG.ps
0	0
0	5.3
EOF
...
foreach w (`gmt math -T1/40/1 -o0 T =`)
	...
	gmt pswiggle -R-0.5/0.5/-0.5/0.5 -JX8i/0.25i -O -K -Gblack -W0.25p,black t.txt -Y0.1i -Z4 >> $FIG.ps
...
gmt pswiggle -R-0.5/0.5/-$s/$n -JX8i/1i -O -K -W0.5p,black t.txt -T0.25p -Gblack -Y0.35i -Z$scl >> $FIG.ps
