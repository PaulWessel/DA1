#!/bin/csh
#	$Id: Fig1_nyquist1.csh 665 2018-12-06 16:40:23Z pwessel $
#
...
gmt psxy -R0/9/0/1.05 -JX4i/1i -P -W1p $start total.d -L+yb -Glightred >! $FIG.ps
...
4.5 0.075 10p,Times-Roman RB aliased
7.5 0.2 10p,Times-Roman LB actual
6 0.5 10p,Times-Roman CB total
