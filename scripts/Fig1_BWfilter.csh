...
#-------------------------------------------------
gmt math -T0/1/0.01 T 0.5 DIV 2 POW 1 ADD INV = BW.txt
gmt psxy -R0/1/0/1.2 -JX2.5i/1.25i BW.txt -P -K -W0.5p -B0/g1-0.5WS --MAP_FRAME_TYPE=graph >! $ps
...
EOF
gmt math -T-1/1/0.01 T PI MUL SINC = BW.txt
gmt math -T-1/1/0.01 T 2.5 MUL 2 POW 0.5 MUL NEG EXP = G.txt
echo "a)" | gmt pstext -R -J -O -K -F+cTL+f16p+jRB -DJ0.15i -N >> $FIG.ps
gmt psxy -R-1/1/-0.4/1.2 -JX2.5i/1.25i BW.txt -O -K -X3.0i -W2p -B0/0g2S --MAP_FRAME_TYPE=graph >> $ps
gmt math BW.txt 0.5 MUL G.txt 0.5 MUL ADD 0.2 SUB = | gmt psxy -R -J -O -K -W1p >> $ps
gmt math BW.txt 0.1 MUL G.txt 0.9 MUL ADD 0.2 SUB = | gmt psxy -R -J -O -K -W0.5p >> $ps
gmt pstext -R -J -O -K -N -F+f+j << EOF >> $ps
