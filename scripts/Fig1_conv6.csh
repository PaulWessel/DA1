#!/bin/csh
#	$Id: Fig1_conv6.csh 665 2018-12-06 16:40:23Z pwessel $
#
...
14 0
EOF
gmt psxy -R0/16/0/1 -JX3.5i/1i -P -K -W0.5p gt.d >! $FIG.ps
...
5 0
EOF
gmt psxy -R0/6/0/1 -JX1.4i/1i -O -K -W0.5p ft.d -X4.0i >> $FIG.ps
