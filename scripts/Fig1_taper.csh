...
gmt psxy -R0/1067/-1000/1000 -JX7.2i/1.35i -P -Bxaf+u" km" -Byafg10000+l"Topography (m)" -BWS tapered.txt -K -W0.5p > $FIG.ps
...
1067	1
EOF
gmt psxy -R0/1067/-1000/1000 -JX7.2i/1.35i -O -K -Bxaf -Byafg10000+l"Topography (m)" -BW res.txt -Y0.75i -W0.5p >> $FIG.ps
