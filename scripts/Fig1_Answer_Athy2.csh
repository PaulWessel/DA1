...
#
# Purpose: Solution to Athy's law (original coordinate plot)
#
set name = $0
set FIG = $name:r
#-------------------------------------------------
...
gmt psxy -R0/6100/7/50 -JX5i/2i -P -K -Bxafg+l"Depth (m)" -Byafg+l"@~q@~"+u"%" -Sc0.075i -Gblack -W0.25p -Ey -BWSne --FONT_LABEL=16p t.txt >! $FIG.ps
